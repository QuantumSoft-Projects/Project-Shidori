      ...
      <div className="w-full max-w-7xl mx-auto bg-white shadow-lg rounded-xl p-6 my-8 border border-gray-100">
                ...
                <tr key={item.id} className="hover:bg-orange-50 transition-colors duration-150">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                    <button 
                      ...
                      className="text-white bg-orange-500 hover:bg-orange-600 p-2 rounded-full shadow-sm hover:shadow transition-all duration-200 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-orange-300"
        ...
        {isDeleteModalVisible && (
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6 transform transition-all animate-fade-in-down">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-gray-500">
                  Are you sure you want to delete <span className="font-medium text-gray-700">{itemToDelete?.ingredient}</span>? This action cannot be undone.
                </p>
              </div>
              <div className="flex flex-col sm:flex-row gap-3 sm:justify-end">
                <button
                  onClick={cancelDelete}
                  className="w-full sm:w-auto order-1 sm:order-0 py-2 px-4 bg-white border border-gray-300 rounded-lg shadow-sm text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 text-sm font-medium transition-all duration-200"
                >
                  Cancel
                </button>
                <button
                  onClick={confirmDelete}
                  className="w-full sm:w-auto order-0 sm:order-1 py-2 px-4 bg-red-600 border border-transparent rounded-lg shadow-sm text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 text-sm font-medium transition-all duration-200"
                >
                  Delete Item
                </button>
              </div>
